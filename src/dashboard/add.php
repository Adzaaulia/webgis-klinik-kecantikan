...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $query = "INSERT INTO `markers` (`name`, `latitude`, `longitude`, `description`, `image`) VALUES ('$name', '$latitude', '$longitude', '$description', '$image')";
    $result = $conn->query($query);
    ...
    if ($result) {
        // get the current url 
        // add params success
        header("Location: $clean_url?success=true");
    } else {
        // add params error
        header("Location: $clean_url?error=true");
    }
}
?>
<!DOCTYPE html>
